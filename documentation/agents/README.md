...
|---|---|---|
| Coding | [`MarqSpec.Client.ProjectX/AGENTS.md`](../../MarqSpec.Client.ProjectX/AGENTS.md) | by **directory proximity** — on your first read of a file in the library |
| QA | [`MarqSpec.Client.ProjectX.IntegrationTests/AGENTS.md`](../../MarqSpec.Client.ProjectX.IntegrationTests/AGENTS.md) | by **directory proximity** — on your first read in that project |
