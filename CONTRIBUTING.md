...
```bash
gh pr list --repo adammarquette/MarqSpec.Client.ProjectX --state open
git ls-remote --heads https://github.com/adammarquette/MarqSpec.Client.ProjectX
```
...
[QA contract](MarqSpec.Client.ProjectX.IntegrationTests/AGENTS.md).
